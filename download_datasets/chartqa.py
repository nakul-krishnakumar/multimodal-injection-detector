"""
Download a sample of 1000 entries from the ChartQA dataset
...
output_dir = Path("data/ChartQA")
output_dir.mkdir(parents=True, exist_ok=True)
images_dir = output_dir / "images"
images_dir.mkdir(exist_ok=True)

print(
    f"Downloading {TOTAL_SAMPLES} entries from ChartQA dataset in batches of {BATCH_SIZE}..."
)
...
for i, item in enumerate(dataset):
    ...
    if len(batch) == BATCH_SIZE or i == TOTAL_SAMPLES - 1:
        ...
        for idx, item in enumerate(batch):
            ...
            image_filename = f"chartqa_{entry_id:06d}.png"

            # Extract query, label, and human_or_machine
...
output_file = output_dir / "chartqa_1000_samples.json"
print("=" * 80)
